        ...
        <div class="main__col">
            <div class="main__left-wrap">
                ...
                <div class="search__container">
                    <form class="search__form" action="/search" method=post><input class="search__input" type="text" name="search"><input class="search__button" type="image" src="/img/icons/search.svg"></form>
                </div>
