        ...
        <div class="main__col footer__col" id="contact">
            ...
            <div class="footer-contact__wrap">
                ...
                <div class="footer-contact__col">
                    ...
                    <ul class="footer-list">
                        <li class="footer-list__item footer-list__item_right"><a class="footer-list__link white" href="#"><img class="footer-list__img" src="/img/icons/phone.svg" alt="">+19732733377</a></li>
		        <li class="footer-list__item footer-list__item_right"><a class="footer-list__link white" href="#">180 Talmadge Road<br>IGO Bldg<br>Edison, NJ 08817<Br>United States</br></a></li>
